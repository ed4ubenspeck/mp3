...
scoring <- grade_tables %>%
  mutate(grade_score = if_else(total_grade_meters <= 5, 1, if_else(total_grade_meters > 5 & total_grade_meters <= 20, 2, if_else(total_grade_meters > 20 & total_grade_meters < 40, 3, if_else(total_grade_meters >= 40 & total_grade_meters <= 50, 4,
