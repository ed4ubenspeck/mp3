...
Each category is broken down into 5 different groups and assigned a score between 1 and 5. The trails in the easiest group (i.e. a trail with a length of less than 500 meters or a trail with a maximum grade change of less than 5 meters) is assigned a score of 1 for that particular category, while a trail in the hardest group (ie. a trail longer than 2000 meters or a trail with a maximum grade change above 60 meters) is assigned a score of 5. After scores are assigned in each category for a particular trail, that trails scores are summed and then divided by three (the number of categories) to give the trail a score out of 5. If the score is below 1.5, the trail is easy. If it is above 1.5 but less than 3.5, it is moderate. Any trail above 3.5 is a difficult one. These trails are plotted and color coded with a corresponding legend to allow hikers to easily see what kind of hike they’ll be embarking on.
